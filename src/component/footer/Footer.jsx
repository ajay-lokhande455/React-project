  ...
  return (
    <div>
      <section className="footer-container bg-color">
        ...
        <hr className="line" />
        <footer className=" footer flex space">
            <div className="copy-right">
                <p>© 2024-2025, All rights reserved BY Ajay</p>
            </div>
            <div className="payment flex">
                <li><svg width="66" height="49" viewBox="0 0 66 49" fill="none" xmlns="http://www.w3.org/2000/svg">
